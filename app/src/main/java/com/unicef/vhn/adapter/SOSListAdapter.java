...
public class SOSListAdapter extends RecyclerView.Adapter<SOSListAdapter.ViewHolder> {
    ...
    String strSosId,strVHNID,str,SosStatus, str_mPhoto, type;
    MakeCallInterface makeCallInterface;


    public SOSListAdapter(List<SOSListResponse.VhnAN_Mothers_List> mResult, Activity applicationContext, String type, MakeCallInterface makeCallInterface) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            txt_mother_type =itemView.findViewById(R.id.txt_list_type);
