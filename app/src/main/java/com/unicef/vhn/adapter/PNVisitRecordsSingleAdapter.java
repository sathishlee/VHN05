...
//        SingleImageHolder singleImageHolder = new SingleImageHolder(v);
    ...
    @Override
    public void onBindViewHolder(final SingleImageHolder imageHolder, final int position) {
