...
public class PNHBNCVisitRecordsAdapter extends PagerAdapter {
    ...
    private ArrayList<PnHbncVisitRecordsModel.PnMothersVisit> mhealthRecordList;
    ...
    private void setValuetoUI(PnHbncVisitRecordsModel.PnMothersVisit mhealthRecordResponseModel) {
        ...
        if (mhealthRecordResponseModel.getPnAnyComplaints().equalsIgnoreCase("null")) {
            ...
            txt_weight.setText(mhealthRecordResponseModel.getPnAnyComplaints() + " Kg");
        }
        ...
        if (mhealthRecordResponseModel.getPnBPSystolic().equalsIgnoreCase("null") &&
                mhealthRecordResponseModel.getPnBPSystolic().equalsIgnoreCase("null")) {
            txt_mother_bp.setText("-");
        } else if (mhealthRecordResponseModel.getPnBPSystolic().equalsIgnoreCase("null")) {
            txt_mother_bp.setText("-" + " / " + mhealthRecordResponseModel.getPnBPSystolic() + " mm Hg");
        } else if (mhealthRecordResponseModel.getPnBPSystolic().equalsIgnoreCase("null")) {
            txt_mother_bp.setText(mhealthRecordResponseModel.getPnBPSystolic() + " mm Hg" + "-");
        } else {
            txt_mother_bp.setText(mhealthRecordResponseModel.getPnBPSystolic() + " mm Hg" + " / " + mhealthRecordResponseModel.getPnBPSystolic() + " mm Hg");
        }
