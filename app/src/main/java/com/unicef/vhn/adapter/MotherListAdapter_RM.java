...
public class MotherListAdapter_RM extends RecyclerView.Adapter<MotherListAdapter_RM.ViewHolder> {
    private List<MotherListAdapterRealmModel> mResult;
    Activity applicationContext;
    MakeCallInterface makeCallInterface;
    String strMid, str_mPhoto, type;


    public MotherListAdapter_RM(List<MotherListAdapterRealmModel> mResult, Activity applicationContext, String type, MakeCallInterface makeCallInterface) {

        Log.e(MotherListAdapter_RM.class.getSimpleName(), "MotherListAdapter_RM");
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final MotherListAdapterRealmModel pNMotherResponseModel = mResult.get(position);
