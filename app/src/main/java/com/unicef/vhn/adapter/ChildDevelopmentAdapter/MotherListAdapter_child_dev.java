...
public class MotherListAdapter_child_dev extends RecyclerView.Adapter<MotherListAdapter_child_dev.ViewHolder> implements Filterable {
    ...
    public MotherListAdapter_child_dev(List<PNMotherListResponse.VhnAN_Mothers_List> mResult, Activity applicationContext,
...
//                    applicationContext.startActivity(new Intent(applicationContext.getApplicationContext(), PNMotherDetailsViewActivity.class));
                    applicationContext.startActivity(new Intent(applicationContext.getApplicationContext(), ChildTrackingViewReportActivity.class));
