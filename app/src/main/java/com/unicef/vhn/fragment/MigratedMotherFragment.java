...
public class MigratedMotherFragment extends Fragment implements MotherListsViews, MakeCallInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = null;
        view = inflater.inflate(R.layout.activity_migration_mothers, container, false);
