...
public class ImmunizationListResponseModel {

    private List<Immunization_list> immunization_list;
    private String message;
    private int status;

    public List<Immunization_list> getImmunization_list() {
        return immunization_list;
    }

    public void setImmunization_list(List<Immunization_list> immunization_list) {
    ...
    public static class Immunization_list {
