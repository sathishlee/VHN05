package com.unicef.vhn.activity.visitMotherDetails;
...
public class PNMotherVisitDetailsActivity extends AppCompatActivity implements View.OnClickListener, MotherListsViews {
