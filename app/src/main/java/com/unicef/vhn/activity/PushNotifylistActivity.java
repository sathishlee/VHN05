...
public class PushNotifylistActivity extends AppCompatActivity implements NotificationViews, MakeCallInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_no_records_found = findViewById(R.id.txt_no_records_found);
        txt_no_internet.setVisibility(View.GONE);
        txt_today_visit_count = findViewById(R.id.txt_today_visit_count);
        txt_count_today_visit = findViewById(R.id.txt_count_today_visit);
        ll_go_visit_list = findViewById(R.id.ll_go_visit_list);
...
//        }
        ll_go_visit_list.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), VisitActivityNew.class));
            }
        });
...
//        mRecyclerView.setHasFixedSize(true);
        ...
        mAdapter = new NotificationAdapter(moviesList, this, this);
